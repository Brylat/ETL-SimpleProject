...
describe('TodosComponent', () => {
  ...
  beforeEach(async () => {
    component = await createComponent('<etl-client-todos></etl-client-todos>', {
  ...
  it('should dispatch add todo action', () => {
    ...
    component.keyUp(
      component.getByPlaceholderText('etl-client.examples.todos.input'),
      {
        target: {
          value: 'poke Tomas'
        }
    ...
    expect(
      (component.getByPlaceholderText(
        'etl-client.examples.todos.input'
