...
describe('FormComponent', () => {
  ...
  beforeEach(async () => {
    component = await createComponent<FormComponent>(
      '<etl-client-form></etl-client-form>',
      {
  ...
  it('should submit when form is valid', async () => {
    component.input(
      component.getByLabelText('etl-client.examples.form.placeholder1'),
      {
        target: {
    ...
    component.input(
      component.getByLabelText('etl-client.examples.form.placeholder2'),
      {
        target: {
    ...
    component.input(
      component.getByLabelText('etl-client.examples.form.placeholder3'),
      {
        target: {
          value: 'foo@bar.baz'
        }
    ...
    component.input(
      component.getByLabelText('etl-client.examples.form.placeholder5'),
      {
        target: {
          value: '1991-12-31'
        }
    ...
    component.input(
      component.getByLabelText('etl-client.examples.form.placeholder4'),
      {
        target: {
    ...
    component.click(component.getByLabelText('etl-client.examples.form.text1'));
    component.click(component.getByText('etl-client.examples.form.send'));
