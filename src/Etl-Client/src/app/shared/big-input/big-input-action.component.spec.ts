...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<etl-client-big-input-action></etl-client-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<etl-client-big-input-action [disabled]="true"></etl-client-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<etl-client-big-input-action fontSet="fas" fontIcon="fa-trash"></etl-client-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<etl-client-big-input-action label="delete"></etl-client-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<etl-client-big-input-action (action)="actionHandler()"></etl-client-big-input-action>`;
    fixture = createHostComponent(template);
